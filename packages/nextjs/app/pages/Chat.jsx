...
const chats = [
  {
    id: 1,
    user: "Charles",
    lastMessage: "Is the blade still available?",
    time: "2m ago",
    avatar: "C",
  },
  {
  ...
  },
  {
    id: 3,
    user: "Jordan",
    lastMessage: "Interested in buying",
    time: "3h ago",
    avatar: "J",
  },
];
      ...
      <div className="w-full sm:w-1/3 bg-[#232323] border-b sm:border-b-0 sm:border-r border-gray-800 p-4 sm:p-6">
        ...
        <ul>
          {chats.map((chat) => (
            ...
            >
              <div className="w-10 h-10 bg-[#3b2ff7] rounded-full flex items-center justify-center text-white font-bold text-lg">
                {chat.avatar}
              </div>
              <div>
